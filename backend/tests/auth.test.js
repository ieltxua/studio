...
describe('Authentication Endpoints', () => {
    beforeEach(async () => {
        ...
        await database_1.prisma.organizationUser.deleteMany();
        await database_1.prisma.user.deleteMany();
        await database_1.prisma.organization.deleteMany();
    });
    afterAll(async () => {
    ...
    describe('POST /api/v1/auth/login', () => {
        ...
        beforeEach(async () => {
            ...
            const hashedPassword = await (0, password_1.hashPassword)('SecurePassword123!');
            testOrganization = await database_1.prisma.organization.create({
                data: {
            ...
            await database_1.prisma.organizationUser.create({
                data: {
                    userId: testUser.id,
